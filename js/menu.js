...
const updateCreateDropdownModal = (username) => {
  let [
    signedInLink,
    userHandleBoldName,
  ...
  userHandleBoldName.appendChild(document.createTextNode(username));
...
const openModal_profile = (username) => {
  // data to be populated in the dropdown odal
  let array = [
  ...
  updateCreateDropdownModal(username);
  // create modal overlay
...
const openModal = (username) => {
  ...
  document
    ...
    .addEventListener('click', () => openModal_profile(username));
};
// openModal();
